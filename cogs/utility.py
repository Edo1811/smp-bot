...
class Utility(commands.Cog):
    ...
    async def help_command(self, interaction: discord.Interaction):
        ...
        embed.add_field(
            ...
            value="`/status` `/online` `/events` `/rank` `/leaderboard` `/topdonors`",
            inline=False
        )
        embed.add_field(
    ...
    # /topdonors — Manual donor leaderboard
    @app_commands.command(name="topdonors", description="View top supporters")
